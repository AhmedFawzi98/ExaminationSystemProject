...
namespace ExaminationSystem.ContextExaminationSystem
{
    ...
    {
        Task<int> SP_Assign_Student_ExamAsync(int? CrID, OutputParameter<int?> ExamId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<SP_Grade_ExamResult>> SP_Grade_ExamAsync(int? stID, int? Cr_ID, int? ExamID, OutputParameter<decimal?> Grade_OUT, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<int> SP_Insert_InstructorAsync(string Ins_Name, string UserName, int? Ins_Salary, string Ins_Degree, int? Dept_ID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<int> SP_Insert_StudentAsync(string Name, string UserName, string Email, string Phone, int? Age, string Street, string City, string Zip_Code, int? Dept_ID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<int> SP_InsertInto_ExamAsync(int? crID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<int> SP_Update_InstructorAsync(int? Ins_ID, string UserName, string Ins_Name, int? Ins_Salary, string Ins_Degree, int? Dept_ID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<int> SP_UPDATE_QuestionAsync(int? id, string head, int? grade, string difficulty, string type, string model, int? course, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<int> SP_Update_StudentAsync(int? ID, string UserName, string Name, string Email, int? Age, string Street, string Phone, string City, string Zip_Code, int? Dept_ID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
